...
class TestBetSizing:
    ...
    def test_max_enforced(self):
        rm = RiskManager(bankroll=2000.0, max_position_pct=0.01, min_trade_usd=1.0, max_trade_usd=8.00)
        assert rm.get_bet_size() <= 8.00  # hard cap $1.50
